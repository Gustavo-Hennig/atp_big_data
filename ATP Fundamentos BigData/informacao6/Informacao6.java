...
public class Informacao6 {
    ...
    public static class MapInformacao extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            try {
                ...
                if (fields.length == 10 && fields[0].equals("Brazil") && fields[1].equals("2016")) {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        String pathOut = "/home2/ead2021/SEM1/hennig.gustavo/Desktop/atp/" + Informacao6.class.getSimpleName();
